...
Project name: my-tauri-ts (원하는 이름)
...
export default function Titlebar() {
  const minimize = (e: React.MouseEvent<HTMLButtonElement>): void => {
    e.stopPropagation();
    getCurrentWindow().minimize();
  };

  const maximize = (e: React.MouseEvent<HTMLButtonElement>): void => {
    e.stopPropagation();
  ...
  return (
    <div className="titlebar" data-tauri-drag-region>
      <div className="title">My TS App</div>
